...
**Внешние источники:** [число] источников; [число] независимых; [число] self-claims (утверждений от объекта о себе)
...
**Уверенность вывода:** `low` / `medium` / `high`.
...
- **Самое сильное альтернативное объяснение:** [что ещё объясняет наблюдения].
- **Что должно случиться, чтобы я изменил вывод:** [наблюдение + источник].
- **Не наблюдали / не доказано:** [важные claims без evidence].
