...
**Внешние источники:** 7 записей; 6 не-self-claim; 1 self-claim
...
- **Самое сильное альтернативное объяснение:** разработчики могут выбирать ручную пересборку из-за разового случая или привычки, а не из-за устойчивого job.
- **Что должно случиться, чтобы я изменил вывод:** 3+ независимых buyer-side кейса с одинаковым контекстом и наблюдаемой оплатой за перенос.
- **Не наблюдали / не доказано:** object-level outcome, повторные платежи, retention и unit economics.
