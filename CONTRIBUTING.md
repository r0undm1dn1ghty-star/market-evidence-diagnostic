...
| Claims | Не переводите self-claim, price page, follower count, launch, star, install или waitlist в proof of demand/outcome. |
...
- [ ] Я не добавил private data, контакты, credentials или непроверенные market claims.
...
Не будут приняты: lead lists, outreach automation, scraping behind login/paywall, скрытый profile enrichment, claims of PMF/revenue guarantees, вложенные proprietary frameworks, а также PR с real customer data без документированного разрешения.
